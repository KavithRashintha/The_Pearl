        ...
        <div>
            ...
            <div className="flex flex-col justify-center items-center pt-10 pb-18">
                ...
                <div className="flex flex-row justify-between w-full px-16">
                    <div className="w-160">
                        <p className="font-medium text-xl mb-6 capitalize text-gray-600">Your ultimate travel companion for discovering the unmatched beauty</p>
                        <p className="font-normal text-md text-justify leading-relaxed">
                    ...
                    <div className="w-full md:w-170 h-76 relative overflow-hidden rounded-lg shadow-xl">
                        <Image
